            ...
            <form @submit.prevent="submit" class="mt-6 space-y-4">
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50/60 p-4">
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3">
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Date de début prévue</label>
                            <input
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Date de début réelle</label>
                            <input
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Date de fin prévue</label>
                            <input
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Date de fin réelle</label>
                            <input
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Durée (jours)</label>
                            <input
